...
//     // Ensure position is always a string and falls back to the default if not in URL
//     const position = searchParams.get('limit') || String(ROWS_PER_PAGE[1])
//     const offset = (currentPage - 1) * parseInt(position)
...
//     useEffect(() => {
//         const totalPages = Math.ceil(totalStudents / parseInt(position))
//         if (totalPages > 0 && currentPage > totalPages) {
//             updateURLParams(totalPages)
//         } else {
//             fetchStudentData(offset)
...
//     // Ensure URL has limit parameter on initial load if missing
//     useEffect(() => {
//         if (!searchParams.get('limit')) {
//             updateURLParams(currentPage, String(ROWS_PER_PAGE[1]))
//         }
//     }, [])
