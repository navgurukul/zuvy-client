...
const ViewAssessmentResults = ({ params }: { params: AssessmentParams }) => {
    ...
    const viewCodingSubmission = (
        ...
        if (codingOutsourseId) {
            navigateTo(
                `/student/course/${params.courseId}/org/${params.orgId}/modules/${params.moduleId}/assessmentResult/${params.submissionId}/codingResult/?codingOutsourseId=${codingOutsourseId}&questionId=${questionId}`
            )
        } else {
            toast.error({
                title: 'Error',
                    ...
                    <div className="bg-card border border-border rounded-lg p-6 shadow-4dp hover:shadow-8dp transition-shadow">
                        ...
                        <div className="flex justify-end">
                            <Button
                                onClick={() =>
                                    navigateTo(
                                        `/student/course/${params.courseId}/org/${params.orgId}/modules/${params.moduleId}/assessmentResult/${assessmentOutsourseId}/quizResult`
                                    )
                                }
                                className="bg-primary hover:bg-primary-dark text-primary-foreground"
                            >
                    ...
                    <div className="bg-card border border-border rounded-lg p-6 shadow-4dp hover:shadow-8dp transition-shadow">
                        ...
                        <div className="flex justify-end">
                            <Button
                                onClick={() =>
                                    navigateTo(
                                        `/student/course/${params.courseId}/org/${params.orgId}/modules/${params.moduleId}/assessment/${assessmentOutsourseId}/openendedresults`
                                    )
                                }
                                className="bg-primary hover:bg-primary-dark text-primary-foreground"
                            >
