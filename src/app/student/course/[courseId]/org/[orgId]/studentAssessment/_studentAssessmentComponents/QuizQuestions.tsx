...
import {Question} from '@/app/student/course/[courseId]/org/[orgId]/studentAssessment/_studentAssessmentComponents/projectStudentAssessmentUtilsType'
                                                ...
                                                <FormControl>
                                                    ...
                                                    >
                                                        {Object.keys(question.options).map((key) => (
                                                            ...
                                                            >
                                                                <RadioGroupItem
                                                                    id={`option-${index}-${key}`} // Unique id
                                                                    value={key}
                                                                    className="mt-0.5"
                                                                />
                                                                <label 
                                                                    // htmlFor={key}
                                                                    htmlFor={`option-${index}-${key}`} // Match this with the id
