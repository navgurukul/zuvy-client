...
import{CodingSubmissionData,TestCase}from '@/app/student/course/[courseId]/codingChallengeResult/codingChallangesStudent'
    ...
    useEffect(() => {
        if (questionId) {
            const fetchSubmission = async () => {
                setLoading(true);
                try {
                    const res = await api.get<CodingSubmissionData>(`/codingPlatform/submissions/questionId=${questionId}`);
