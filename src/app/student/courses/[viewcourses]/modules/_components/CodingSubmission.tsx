...
const CodingSubmission = ({ codingSubmissionsData }: { codingSubmissionsData: any }) => {
                            ...
                            (submission: any, index: number) => (
                                ...
                                >
                                    ...
                                    <p className="text-gray-600">
                                        ...
                                        <ul>
                                            {submission.testCases.inputs.map(
                                                (input: any, i: number) => (
                                                    <li key={i}>
                                                        {input.parameterName}:{' '}
                                    ...
                                    <p className="text-gray-600">
                                        ...
                                        {
                                            submission.testCases.expectedOutput
                                                .parameterValue
                                        }
                                    </p>
                                    <p className="text-gray-600">
                                        <strong>Your Output:</strong>{' '}
                                        {submission.stdout || 'N/A'}
                                    </p>
                                    {submission.stderr && (
