...
// import {AssessmentProps, AssessmentShortInfo,
//   SubmittedAssessment,} from "@/app/student/courses/[viewcourses]/modules/_components/type"
// import {
//     Dialog,
//     DialogOverlay,
//     DialogContent,
...
//         assessmentShortInfo?.timeLimit ?? 0
//     )
...
//     useEffect(() => {
//         setTestDuration(assessmentShortInfo?.timeLimit ?? 0)
...
//                             Total Marks:{' '}
//                             {(assessmentShortInfo?.weightageMcqQuestions ?? 0)+
//                                 (assessmentShortInfo?.weightageCodingQuestions ?? 0)}
//                         </h2>
//                     </div>
//                     {hasQuestions ? (
...
//                                 <div>
//                                     <h2 className="text-lg font-semibold text-secondary">
//                                         {(assessmentShortInfo?.easyMcqQuestions ?? 0) +
//                                             (assessmentShortInfo?.mediumMcqQuestions ?? 0) +
//                                             (assessmentShortInfo?.hardMcqQuestions ?? 0)}
//                                     </h2>
//                                     <p className="text-sm text-gray-600">
//                                         MCQs
//                                     </p>
...
import { api } from '@/utils/axios.config'
import { is } from 'immutable'
import {AssessmentProps, AssessmentShortInfo} from "@/app/student/courses/[viewcourses]/modules/_components/type"
