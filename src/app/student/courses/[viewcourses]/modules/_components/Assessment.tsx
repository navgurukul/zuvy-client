...
const Assessment = ({
    ...
    const isAssessmentStarted = assessmentShortInfo?.submitedOutsourseAssessments?.[0]?.startedAt
                    ...
                    <TooltipProvider>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <div>
                                    <Button
                                        className={`bg-secondary text-white px-6 py-2 rounded-md shadow-md ${isDisabled ? 'cursor-not-allowed opacity-50' : 'hover:bg-green-700'
                                            }`}
                                        onClick={handleStartAssessment}
                                        disabled={isDisabled}
                                    >
