...
// // ***************************** Login Page Grid with small pop up google.accounts.id.prompt() ************************************
// 'use client'
...
//     //             // Send it to your backend to verify
...
//         window.google.accounts.id.prompt() // or use renderButton if you want popup
//     }
...
//                 credential:
//                     'ya29.a0AW4Xtxh6o_qTc8f3WLiOLVdN2NuC2bS5mtJLXHItCdTvmT7gtHaPntimM4DD7t5CzLiAU8twRiqtdtUI-L23NAHz7S5eA7QsTHa_ho7SrTPiWZV6VeoVH9e1LCEhVfaHMhsuNgG0z_gF_HsBW4ZVIZnroBFnE3JBFrO34fNGaCgYKAfYSARMSFQHGX2Mi4EEHwx1iieQR1zLyvSxfFA0175',
//                 select_by: 'user',
//             }
...
//                                         className="bg-[#518672] hover:bg-[#2f433a] active:bg-[#1f2e26]
//                    transition-colors duration-200 ease-in-out
//                    flex items-center justify-start space-x-3
//                    w-[250px] h-12 px-4 py-3
//                    text-white text-base font-medium
//                    rounded-md border border-transparent
//                    focus:outline-none focus:ring-2 focus:ring-[#518672] focus:ring-offset-2
...
// ***************************** With big pop up google.accounts.id.prompt() ************************************
'use client'
...
function LoginPage({}: Props) {
    ...
    // In your component or a useEffect
    // useEffect(() => {
    //     /* global google */
    ...
    //             ux_mode: 'popup', // IMPORTANT: For center popup
    //         })

    //         // You don't need to render the default button
