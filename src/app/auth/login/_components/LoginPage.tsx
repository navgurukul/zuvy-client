...
function LoginPage({}: Props) {
    ...
    const socialProofData = [
        { type: 'student', name: 'Vaishnavi Deokar', role: 'SDE Intern at Amazon', avatar: 'VS', image: '/vaishnavi.jpg' },
        { type: 'metric', number: '2000+', description: 'Learners across 18 states' },
        { type: 'student', name: 'Varun Guleria', role: 'Intern at Microsoft', avatar: 'VG', image: '/varu.jpg' },
        { type: 'metric', number: '400+', description: 'Internships secured' },
        { type: 'student', name: 'Astha Negi', role: 'Intern at Amazon', avatar: 'AN', image: '/ashi.jpg' },
        { type: 'metric', number: 'Over 70%', description: 'Learners are women' },
        { type: 'student', name: 'Ayushi Shah', role: 'SDC Intern at Amazon', avatar: 'AS', image: '/ayush.jpg' },
    ...
    const StudentCard = ({ name, role, avatar, image }: { name: string; role: string; avatar: string; image: string }) => (
                            ...
                            <div className="hidden md:block">
                                ...
                                <div className="flex justify-center gap-2 mb-2">
                                    {firstRowCards.map((card, index) => (
                                        <div key={index}>
                                            {card.type === 'student' ? (
                                                <StudentCard name={card.name!} role={card.role!} avatar={card.avatar!} image={card.image!} />
                                            ) : (
