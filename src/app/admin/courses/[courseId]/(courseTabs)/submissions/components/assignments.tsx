                    ...
                    return (
                        <div className="" key={data.id}>
                            ...
                            <div className="grid grid-cols-1 gap-8 mt-2 md:mt-4 md:grid-cols-2 lg:grid-cols-3">
                                {data.moduleChapterData.map((moduleData: any) => {
                                    const isDisabled = moduleData.submitStudents === 0;
                                        ...
                                        >
                                            ...
                                            <div className="absolute top-2 right-2 group">
                                                <button
                                                    ...
                                                    onClick={isDisabled ? undefined :()=>handleDownloadPdf(Number(chapterId))}
                                            ...
                                            <div className="font-semibold flex w-full flex-col justify-between">
                                                <div className="flex w-full">
                                                    <h1 className="w-1/2">{moduleData.title}</h1>
                                                    <h2 className="w-1/2 flex">
                                                        <span>Total Submitted: </span>
                                                        <span>{moduleData.submitStudents}</span>
                                                    </h2>
                                                </div>
