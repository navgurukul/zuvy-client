        ...
        async function fetchData() {
            try {
                ...
                if (Array.isArray(assessments)) {
                    const doc = new jsPDF();
                    doc.setFontSize(18);
                    doc.text(props.title, 14, 10); // Title
    
                    // Add Passed Percentage
                    doc.setFontSize(16);
                    doc.text('Passed Percentage: 70%', 14, 20); // Add a line for passed percentage
    
                    // Add section title
                    doc.setFontSize(16);
                    doc.text('List of Students', 14, 30); // Start below the passed percentage
                    ...
                    autoTable(doc, {
                        ...
                        body: rows.map(row => [row.name, row.email, row.Qualified, row.percentage]),
                        startY: 40,
                    ...
                    console.error('Expected submitedOutsourseAssessments to be an array, but got:', assessments);
                }
            ...
            <div className="w-full justify-between py-2 lg:mx-4 min-h-[250px] sm:min-h-[200px]">
                <div className="flex items-center justify-between">
                    ...
                    <div className="relative group">
                        ...
                        <div className="absolute right-0 bottom-full mb-2 hidden px-2 py-1 text-xs text-white bg-gray-800 rounded group-hover:block whitespace-nowrap">
                ...
                <div className="flex flex-col gap-y-3 lg:gap-x-6 my-3 pb-3 flex-grow">
                    <div className="flex flex-row items-center gap-x-2">
                        <div className={`h-3 w-3 rounded-full ${
                            props.studentsSubmitted / props.totalSubmissions > 0.8
                            ? 'bg-green-400'
