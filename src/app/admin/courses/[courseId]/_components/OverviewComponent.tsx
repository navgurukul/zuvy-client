...
const OverviewComponent = (props: OverviewComponentProps) => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="text-left text-lg font-semibold mb-4">Score Overview</h3>
          ...
          {props.totalCodingChallenges > 0 && (
            <Card>
              <CardContent className="p-4 text-center">
                ...
                <p className="text-sm text-muted-foreground mb-1">Coding Challenges</p>
      ...
      <div>
        <h3 className="text-left text-lg font-semibold mb-4">Proctoring Report</h3>
            ...
            {props?.proctoringData?.canCopyPaste && (
              <Card className="border-yellow-200 bg-yellow-50">
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-sm text-yellow-600">Copy Paste</p>
                </CardContent>
              </Card>
            )}
