...
import { Check, CheckCircle, User, X, XCircle, ClockIcon, Code, CheckSquare, FileText,ArrowLeft } from 'lucide-react'
            ...
            <MaxWidthWrapper className="p-10">
                ...
                {codingdata ? (
                    <div className="space-y-8">
                        <h3 className="text-left text-lg font-semibold mb-4 mt-8">Question Breakdown</h3>
                        ...
                        {(assesmentData?.submitedOutsourseAssessment?.easyMcqQuestions ||
                            assesmentData?.submitedOutsourseAssessment?.mediumMcqQuestions ||
                            assesmentData?.submitedOutsourseAssessment?.hardMcqQuestions > 0) && (
                                <div className="w-full">
                                    <div className="flex items-center gap-2 mb-4">
                            ...
                            <div className="w-full">
                                ...
                                {assesmentData?.openEndedQuestionCount === 0 &&
                                    ...
                                    <p className="text-center py-20 font-semibold h-[100px] w-4/5 shadow-lg transition-transform transform hover:shadow-xl">
                                        There are no open-ended questions in this assessment.
                                    </p>
                                ) : assesmentData?.attemptedOpenEndedQuestions >=1 ? (
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                        <IndividualStudentAssesment
                                            data={[]}
                                            params={params}
                                    ...
                                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                                        <Card className="cursor-pointer hover:shadow-md transition-shadow">
                                            <CardContent className="p-4">
                                                <div className='mb-4'>
                                                    <p className="text-base font-bold mb-1">
                                                        This student has not submitted any open-ended questions.
                                                    </p>
                                                </div>
                                            </CardContent>
                                        </Card>
