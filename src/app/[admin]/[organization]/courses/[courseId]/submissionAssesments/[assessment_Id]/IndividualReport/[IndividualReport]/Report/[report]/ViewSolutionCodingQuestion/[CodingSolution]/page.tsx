...
} from '@/app/[admin]/[organization]/courses/[courseId]/submissionAssesments/[assessment_Id]/IndividualReport/[IndividualReport]/Report/[report]/ViewSolutionCodingQuestion/SubmissionViewPageType'
                        ...
                        <div className="flex flex-row items-center gap-x-6">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-left text-muted-foreground text-sm">
                                    Detailed submission analysis and performance
                                    metrics
                                </p>
                            </div>
                        </div>
