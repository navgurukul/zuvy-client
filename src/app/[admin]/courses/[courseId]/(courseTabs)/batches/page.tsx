...
import { StudentData, BatchSuggestion, StudentDataState, ParamsType } from "./courseBatchesType"
                                    ...
                                    <CardContent className="space-y-3">
                                        ...
                                        {batch.startDate && batch.endDate && (
                                            <div className="flex items-center gap-2 text-sm">
                                                ...
                                                <span className="text-xs">{formatDate(batch.startDate)} - {formatDate(batch.endDate)}</span>
                                            </div>
                                        )}
                                    </CardContent>
