...
import React, { useEffect } from 'react'
import { getQuizPreviewStore, getUser } from '@/store/store'
import { fetchPreviewData } from '@/utils/admin'
import { ArrowLeft } from 'lucide-react'
import Link from 'next/link'
import { addClassToCodeTags } from '@/utils/admin'
...
import {
    Params,
    TopicCodingQuestion,
} from '@/app/[admin]/[organizationId]/courses/[courseId]/module/[moduleId]/chapter/[chapterId]/assignment/[topicId]/preview/TopicIdPageType'
    ...
    return (
        <>
            ...
            <div className="fixed bottom-5 right-8">
                <Button className="bg-success-dark opacity-75" disabled>
                    Submit
                </Button>
            </div>
        </>
