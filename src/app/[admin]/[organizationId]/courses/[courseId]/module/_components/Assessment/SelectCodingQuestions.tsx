...
import QuestionDescriptionModal from '@/app/[admin]/[organizationId]/courses/[courseId]/module/_components/Assessment/QuestionDescriptionModal'
...
const SelectCodingQuestions = ({
    ...
    const handleQuestionRemoval = (
        ...
        setSelectedQuestions: React.Dispatch<
            React.SetStateAction<{ id: number; [key: string]: any }[]>
        >,
