...
import {
    TestCase,
    InputPage,
} from '@/app/[admin]/[organizationId]/courses/[courseId]/submissionAssesments/[assessment_Id]/IndividualReport/[IndividualReport]/Report/[report]/ViewSolutionCodingQuestion/SubmissionViewPageType'
import {
    CheckCircle2,
    XCircle,
    Clock,
...
const TestCaseResults = ({ testCases }: any) => {
    const passedTestCases =
        testCases?.filter((tc: TestCase) => tc.status === 'Accepted')?.length ||
        0
