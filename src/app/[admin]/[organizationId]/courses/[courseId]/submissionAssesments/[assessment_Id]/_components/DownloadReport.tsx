...
import {
    ...
    ReportData,
    DownloadReportProps,
} from '@/app/[admin]/[organizationId]/courses/[courseId]/submissionAssesments/[assessment_Id]/_components/submissionComponentDownloadType'
            ...
            body: [
                [
                    ...
                    `${reportData.PracticeCode.length || 0} / ${
                        reportData.submitedOutsourseAssessment
