...
import DeleteConfirmationModal from '@/app/[admin]/[organizationId]/courses/[courseId]/_components/deleteModal'
...
import { CurricullamCardProps } from '@/app/[admin]/[organizationId]/courses/[courseId]/_components/adminCourseCourseIdComponentType'
...
const CurricullumCard = (props: CurricullamCardProps) => {
    ...
    return (
        ...
        >
            <Card
                className={`shadow-sm my-2 w-full transition-all duration-300 hover:shadow-md ${
                    showBorderFlash
            ...
            >
                <CardHeader className="pb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div 
                            className="flex-1 flex items-center justify-between  p-2 rounded-md transition-colors"
