    ...
    <MaxWidthWrapper>
      <div className="py-12">
        <div className="mx-auto max-w-3xl">
          ...
          {completenessGate && completenessGate.isComplete && (
            <div className="mb-8 rounded-lg border border-success bg-success-light dark:bg-success-light/10 px-5 py-4">
              <div className="flex items-start gap-3">
            ...
            <div className="rounded-lg border border-border bg-card-light p-6 shadow-sm">
              ...
              >
                {expertise.map((tag) => (
                  <span
                    key={tag}
                    className="inline-flex items-center gap-2 rounded-full bg-primary-light dark:bg-primary-light/20 px-3 py-1.5 text-caption font-semibold text-primary"
                  >
                    {tag}
                    <button
                      type="button"
