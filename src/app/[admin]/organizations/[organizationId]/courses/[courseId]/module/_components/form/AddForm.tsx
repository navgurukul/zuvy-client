...
import {
    AddFormProps,
    FormQuestionDetail,
} from '@/app/[admin]/organizations/[organizationId]/courses/[courseId]/module/_components/form/ModuleFormType'
import {FeedbackFormSkeleton} from '@/app/[admin]/organizations/[organizationId]/courses/[courseId]/_components/adminSkeleton'
...
const AddForm: React.FC<AddFormProps> = ({
    ...
    function previewForm() {
        ...
        if (content) {
            ...
            router.push(
                `/${userRole}/organizations/${organizationId}/courses/${courseId}/module/${content.moduleId}/chapter/${content.id}/form/${content.topicId}/preview`
            )
        }
    }
