...
const ProjectPreview = () => {
    ...
    return (
        <>
            <div className="fixed top-0 left-0 right-0 h-12 bg-primary flex items-center justify-center z-50">
                <h1 className="text-center text-[16px] text-primary-foreground">
