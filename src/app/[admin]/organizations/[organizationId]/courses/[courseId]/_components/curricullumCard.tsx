...
import { CurricullamCardProps } from '@/app/[admin]/organizations/[organizationId]/courses/[courseId]/_components/adminCourseCourseIdComponentType'
...
const CurricullumCard = (props: CurricullamCardProps) => {
    ...
    const handleModuleRoute = () => {
        if (typeId === 1) {
            router.push(
                `/${userRole}/organizations/${orgId}/courses/${courseId}/module/${moduleId}/chapters/${chapterId}`
            )
        } else if (typeId === 2) {
            router.push(
