...
import {VideoSubmissionSkeleton} from '@/app/[admin]/organizations/[organizationId]/courses/[courseId]/_components/adminSkeleton'
                                            ...
                                            >
                                                ...
                                                <div className="absolute top-3 right-2">
                                                    {video.completedStudents > 0 ? (
                                                        ...
                                                        <Link
                                                            href={`/${userRole}/organizations/${orgId}/courses/${courseId}/submissionVideo/${video.id}`}
                                                        >
                                                            <Button
                                                            variant="ghost"
