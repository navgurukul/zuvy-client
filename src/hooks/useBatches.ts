...
import { createColumns } from '@/app/[admin]/[organizationId]/courses/[courseId]/(courseTabs)/batches/columns'
import {
    StudentData,
    BatchSuggestion,
    StudentDataState,
    ...
    EnhancedBatch,
    PermissionsType,
} from '@/app/[admin]/[organizationId]/courses/[courseId]/(courseTabs)/batches/courseBatchesType'
