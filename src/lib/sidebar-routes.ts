...
const adminRoutes = [
    ...
    { label: 'Resource Library', icon: Database, href: "",
        subtabs: [
            { label: 'Coding Problems', href: '/admin/resource/coding', icon: Video},
            { label: 'MCQs', href: '/admin/resource/mcq',  icon: Video},
            { label: 'Open-Ended Questions', href: '/admin/resource/open-ended',  icon: Video},
        ]
     },
